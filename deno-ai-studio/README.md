# [Deno AI Studio](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.39.exe)
...
Current installer: **Deno AI Studio Setup 0.1.39.exe**

Latest update: Stable Audio now includes a step-by-step Hugging Face token guide with direct token and model-page links. HeartMuLa Tips also wraps long tag examples correctly and shows recommended time values in seconds.
...
6. Download and run **Deno AI Studio Setup 0.1.39.exe**
...
- The correct install order is WSL 2 + Ubuntu, Docker Desktop, then the Deno AI Studio Windows installer.
- Use this WSL command: wsl --install -d Ubuntu
- Explain that WSL and Ubuntu are different, and that Ubuntu may ask me to create a Linux username/password after reboot.
- Tell me to install Docker Desktop for Windows x86_64.
- Tell me to enable Docker Desktop Settings > Resources > WSL Integration > Ubuntu.
- Tell me to use the current download button/link in the README, not an older guessed installer version.
- If I am stuck, ask me to paste the PowerShell result of: wsl -l -v
```
...
[Download Deno AI Studio Setup 0.1.39.exe](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.39.exe)

Then:

1. Run `Deno AI Studio Setup 0.1.39.exe`
