# [Deno AI Studio](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.62.exe)
...
Current installer: **Deno AI Studio Setup 0.1.62.exe**

Latest update: The DENO green UI refresh has been softened so catalog buttons, progress bars, drag states, and modal glows are easier on the eyes.
...
4. Download and run **Deno AI Studio Setup 0.1.62.exe**.
...
[Download Deno AI Studio Setup 0.1.62.exe](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.62.exe)

Then:

1. Run `Deno AI Studio Setup 0.1.62.exe`.
